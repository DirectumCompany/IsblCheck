...
namespace IsblCheck.Context.Development.Folder.Handlers
{
  ...
  /// </summary>
  internal class DocumentRequisiteFolderHandler : FolderHandlerBase<DocumentRequisite, ComponentModel>
  {
    #region Константы
    ...
    protected override string FolderName { get { return "DocumentRequisites"; } }

    protected override string CardModelRootNode { get { return "DocumentRequisite"; } }
